import { performance, Map, parseCommandLine, ExitStatus, sys, validateLocaleAndSetLanguage, createCompilerHost, createProgram, CompilerOptions, createDiagnosticReporter, createCompilerDiagnostic, normalizePath, combinePaths, Diagnostics, findConfigFile, isWatchSet, DiagnosticMessage, sort, filter, compareStringsCaseInsensitive, optionDeclarations, createMap, CommandLineOptionOfListType, arrayFrom, CommandLineOption, parseConfigFileWithSystem, ParsedCommandLine, WatchCompilerHost, EmitAndSemanticDiagnosticsBuilderProgram, Program, forEach, getLineStarts, createWatchProgram } from 'byots';
import * as ts from 'byots';
import {tsclone as TSWatch} from './watch';
const { emitFilesAndReportErrors } = TSWatch;

// Everything in this namespace was copied verbatim from typescript's tsc.ts
